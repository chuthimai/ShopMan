...
<%@page import="dao.Type082DAO"%>
<%@page import="model.item.Type082"%>
...
<body>
    ...
    <%
        ArrayList<Type082> allType = (new Type082DAO()).getAllType();
    %>
    ...
    <div class="container">
        <form action="${pageContext.request.contextPath}/doAddNewItem" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-8">
                    <div class="mb-3">
